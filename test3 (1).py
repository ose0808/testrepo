                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(id='input-type', 
                                                    ...
                                                    style={'width':'80%','paddding':'3px','front-size':'20px','text-align-last':'center'}),
                                   ...
                                   html.Div([
                                       # Create an division for adding dropdown helper text for choosing year
                                        ...
                                        dcc.Dropdown(id='input-year', 
                                          ...
                                          ]),html.Div([ ], id='plot1'),html.Div([html.Div([ ], id='plot2'),html.Div([ ], id='plot3')
...
def get_graph(chart, input_year, children1, children2, c3, c4, c5):
